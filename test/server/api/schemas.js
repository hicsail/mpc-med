'use strict';
const SchemaPlugin = require('../../../server/api/schemas');
...
lab.before((done) => {
  ...
  stub = {
    Schema: MakeMockModel()
  };

  const proxy = {};
  proxy[Path.join(process.cwd(), './server/models/schema')] = stub.Schema;
  ...
  const plugins = [HapiAuthBasic, HapiAuthCookie, HapiAuthJWT, ModelsPlugin, AuthPlugin, SchemaPlugin];
...
lab.experiment('Schema Plugin Result List', () => {
  ...
  lab.test('it returns an error when paged find fails', (done) => {
    ...
    stub.Schema.pagedLookupById = function () {
...
lab.experiment('Schema Plugin Result List', () => {
  ...
  lab.beforeEach((done) => {
    ...
    request = {
      method: 'GET',
      url: '/table/schemas?search[value]=""',
      credentials: AuthenticatedAdmin
    };
  ...
  lab.test('it returns an array of documents successfully using filters', (done) => {
    ...
    request.url = '/table/schemas?fields=username ip time&order[0][dir]=desc&search[value]=test';
  ...
  lab.test('it returns an array of documents successfully using filters', (done) => {
    ...
    request.url = '/table/schemas?fields=username ip time&order[0][dir]=asc&search[value]=test';
    request.credentials = AuthenticatedAnalyst;
...
lab.experiment('Schema Plugin Read', () => {

  lab.beforeEach((done) => {

    request = {
      method: 'GET',
      url: '/schemas/93EP150D35',
      credentials: AuthenticatedAdmin
    };
  ...
  lab.test('it returns an error when find by id fails', (done) => {
    ...
    stub.Schema.findById = function (id, callback) {
...
lab.experiment('Schema Plugin Delete', () => {
  ...
  lab.test('it returns an error when delete by id fails', (done) => {
    ...
    stub.Schema.findByIdAndDelete = function (id, callback) {
...
lab.experiment('Schema Plugin Update', () => {

  lab.beforeEach((done) => {

    request = {
      method: 'PUT',
      url: '/schemas/420000000000000000000000',
      payload: {
        name: 'name',
  ...
  lab.test('it returns an error when update fails', (done) => {
    ...
    stub.Schema.findByIdAndUpdate = function (id, update, callback) {
...
lab.experiment('Schema Plugin Create', () => {
  ...
  lab.test('it returns an error when create fails', (done) => {
    ...
    stub.Schema.create = function (name, description, userId, users, columns, callback) {
